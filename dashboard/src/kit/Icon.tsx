...
/** Killcam's glyphs, drawn to the design system's rules (24×24, 1.8 stroke,
 *  round caps, currentColor). The design system's Icon covers its own set;
 *  these add what a debugger needs (network, skull, replay...). */
